...
int main(int argc, char* argv[]) {
    ...
    // Declare variables
    vector<vector<double> > box_dim(3, vector<double>(3)) = {{15, 0, 0}, {0, 15, 0}, {0, 0, 15}};
    ...
    // generate positions
    positions = generateParticles(total_n_atoms, rho);
    ...
    while(total_accepted_moves < num_trails){
        ...
        auto(x_new, y_new, z_new) = pos(total_n_atoms, box_dim, positions, step_size);
        ...
        cout << "Step: " << step << ", Acceptance Ratio: " << acceptance_ratio << endl;
